-- Fix marketplace/clone: on_chatbot_created already inserts chatbot_flows;
-- reuse that row instead of inserting a second one.
...
begin
  ...
  -- Trigger on_chatbot_created already created Main flow + default nodes.
