...
export function ConfirmAnswerField({
  ...
  return (
    <label
      className={cn(
        'flex min-w-0 flex-1 cursor-pointer items-start gap-3 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-2)]/60 px-3.5 py-3 transition',
        'hover:border-[var(--color-accent)] hover:bg-[var(--color-accent-soft)]/40',
