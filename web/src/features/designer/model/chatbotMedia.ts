...
export function chatTextHasWhatsappEmbed(text: string | null | undefined): boolean {
  if (!text) return false
  return parseChatSegments(text).some((seg) => seg.kind === 'whatsapp')
}
